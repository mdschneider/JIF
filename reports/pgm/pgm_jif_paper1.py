...
pgm.add_node(daft.Node("PSF", r"PSF$_{i}$", 1, 1.5, observed=True))
pgm.add_node(daft.Node("noise", r"$\sigma_{n,i}$", 1, 0.5, observed=True))
...
pgm.add_plate(daft.Plate([1.6, 0.4, 1.19, 2.25], label=r"galaxies $n$", label_offset=[5, 5]))
pgm.add_plate(daft.Plate([0.6, 0.1, 2.0, 1.75], label=r"epochs $i$", label_offset=[45, 5]))
